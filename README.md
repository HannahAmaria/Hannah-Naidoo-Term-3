...
- The login, sign up and cart functionality was quite easy to implement
- ChatGPT made the workload easier
...
- I would have loved to spend more time working on the front end design
...
- **Original Project Link** - https://github.com/HannahAmaria/Hannah-Naidoo-Term-3
